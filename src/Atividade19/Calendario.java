...
public class Calendario {
    ...
    public void diferencaDias(LocalDate data1, LocalDate data2) { //<- mudei propositalmente para void
      //  return Math.abs(ChronoUnit.DAYS.between(data1, data2)); // <- tem que verificar versão do JDK as vezes não funciona
    }
}